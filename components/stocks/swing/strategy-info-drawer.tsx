...
const STRATEGY_INFO: Record<StrategyKey, StrategyInfo> = {
  ...
  ema: {
    ...
    filters: [
      ...
      { label: "Low-volume pullback", desc: "The dip should be quiet — institutions aren't selling, just weak hands exiting." },
    ...
    exitLogic: "Enter at today's close. Stop 2% below the 20 EMA. Target +4% from entry.",
    tip: "The best EMA pullbacks happen in 2–3 red days with below-average volume, followed by a green reversal day.",
  },
  vcp: {
